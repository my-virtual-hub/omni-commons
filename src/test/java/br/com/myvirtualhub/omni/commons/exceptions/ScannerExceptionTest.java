...
class ScannerExceptionTest {
    ...
    void testConstructorWithMessageAndThrowableCause() {
        String message = "Test message";
        String throwableCause = "Test throwable cause";
        ScannerException exception = new ScannerException(message, throwableCause);
        assertEquals(message, exception.getMessage());
        assertEquals(throwableCause, exception.getThrowableCause());
    }
}
